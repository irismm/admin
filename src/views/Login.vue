  ...
  <div class="login-container">
    <div class="login-block">
      ...
      <div class="login-block-info">
        <el-form ref="loginForm" :rules="loginDataRule" :model="loginData" class="loginForm" @keypress.native.enter="doLogin">
          ...
          <el-form-item prop="password">
            <el-input v-model="loginData.password" placeholder="请输入密码" type="password" @keyup.native.enter="doLogin">
